# Preview.11 supervised Buyer bootstrap and Provider offer lifecycle

> **GATED_UNRELEASED:** `v0.1.0-preview.11` is not installable until GitHub
> publishes a non-draft Linux/x64 prerelease with a matching archive and
> `SHA256SUMS` asset.

Preview.11 keeps the Preview.9 clean-v4, owner-targeted zero-price lifecycle,
