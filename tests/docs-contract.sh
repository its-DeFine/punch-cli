...
require docs/COMMANDS.md 'non-draft prerelease archive'
require docs/COMMANDS.md 'checksum are published'
...
require docs/PREVIEW14_COMMAND_REFERENCE.md '830160e9b4209baa18745c948505c8d9731d9ccc'
require docs/PREVIEW14_COMMAND_REFERENCE.md '5c39f16be6f0d9ec9bd0add3c6fd33cf3360ed26'
...
require docs/preview14-public-command-contract.template.json '841d34705dea77a31a9090d87e835190b9db8b2d8edb880112148557b08001c3'
