...
require docs/EXECUTABLE_DOCS.md 'A `202` stop operation does'
require docs/EXECUTABLE_DOCS.md '`503` is a generic retryable projection'
require docs/EXECUTABLE_DOCS.md 'exact retry returns the same operation'
require docs/EXECUTABLE_DOCS.md 'bounded 30-second deadline'
require docs/EXECUTABLE_DOCS.md '300-second overall'
require docs/EXECUTABLE_DOCS.md 'BUYER_PROTOCOL_INVALID'
require docs/ARCHITECTURE.md 'The next gated async-stop contract is documented'
...
require docs/PUNCH_PUBLIC_SAFE_ASYNC_STOP_CONTRACT_20260804.md 'GET returns'
require docs/PUNCH_PUBLIC_SAFE_ASYNC_STOP_CONTRACT_20260804.md 'fail-closed `404`'
require docs/PUNCH_PUBLIC_SAFE_ASYNC_STOP_CONTRACT_20260804.md 'never creates stop intent'
require docs/PUNCH_PUBLIC_SAFE_ASYNC_STOP_CONTRACT_20260804.md 'cleanupState: "PENDING"'
require docs/PUNCH_PUBLIC_SAFE_ASYNC_STOP_CONTRACT_20260804.md '## CLI reconciliation'
...
require docs/PUNCH_PUBLIC_SAFE_ASYNC_STOP_CONTRACT_20260804.md 'POST /api/v0/buyer/jobs/{jobId}/stop'
