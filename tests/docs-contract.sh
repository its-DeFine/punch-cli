...
require docs/COMMANDS.md 'matching non-draft prerelease'
require docs/COMMANDS.md 'archive and checksum are published'
...
require docs/PROVIDER.md 'punch-cli-0.1.0-preview.14-linux-x64.tar.gz'
...
require docs/PROVIDER.md 'run guided `punch`, `identity-init`, `join`, or `setup` as an install or'
...
require docs/INVITATIONS.md '`v0.1.0-preview.14` invitation-only flow'
require docs/INSTALL.md 'Preview.14, the later supervised Provider `setup` operation owns reviewed'
...
require docs/GUIDED_CLI.md 'UNRELEASED IMPLEMENTATION CONTRACT'
require docs/GUIDED_CLI.md 'Release authority: false.'
require docs/GUIDED_CLI.md 'not present in'
require docs/GUIDED_CLI.md '`v0.1.0-preview.14` or its published archive'
